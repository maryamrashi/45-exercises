...
let toLOWERCASE:string="lowercase:alice";
...
console.log("\n\t\"FAMOUS QUOTE 2\"")
let quote:string="\"YOUR MIND IS A POWERFUL THING WHEN YOU FILL IT WITH POSITIVE THOUGHTS,YOUR LIFE WILL START TO CHANGE.\"";
...
console.log("\n\t\"NAMES\"")
let friendsnames:string[]=["KAYCEE","MILA","ANDREA","EMILY"];
...
console.log("\n\t\"GREETINGS\"")
let friendsname:string[]=["KAYCEE","MILA","ANDREA","EMILY"];
let messages:string="SHE IS MY VERY GOOD FRIEND:";
...
console.log("\n\t\"MY OWN ARRAY\"")
let vehicles:string[]=["TOYOTA CAR","AIRPLANE","TRAIN","HEAVYBIKE"]
...
console.log("\n\t\"GUEST LIST\"")
let guestlist:string[]=["Rabiya","Kanwal","Abeeha"]
...
console.log("\n\t\"CHANGING GUEST LIST\"")
let gguestlist:string[]=["Rabiya","Kanwal","Abeeha"]
gguestlist.pop();
...
let guestllist:string[]=["Rabiya","Kanwal","Abeeha"];
guestllist.pop();
...
let guestliist:string[]=["Hira","Kanwal","Rabeeca","Abeeha"];
guestliist.pop();
...
let guuestliist:string[]=[];//empty list
...
console.log("\n\t\"SEEING THE WORLD\"")
let places:string[]=["PAKISTAN","CHINA","KOREA","EUROPE","INDIA"];
console.log("Oranginal Order",places);
let placess:string[]=["CHINA","EUROPE","INDIA","KOREA","PAKISTAN"]
console.log("Alphabetical Order",placess)
console.log("Original Order",places);
let pplaces:string[]=["PAKISTAN","KOREA","INDIA","EUROPE","CHINA"];
console.log("Reverse Alphabatical Order",pplaces);
console.log("Original Order",places);
let pplacces:string[]=["CHINA","EUROPE","INDIA","KOREA","PAKISTAN"];
console.log("Reverse Order",pplacces);
console.log("Original Order",places);
let plaaces:string[]=["CHINA","EUROPE","INDIA","KOREA","PAKISTAN"]
console.log("Alphabetical Order",plaaces);
let places1:string[]=["PAKISTAN","KOREA","INDIA","EUROPE","CHINA"];
...
console.log("EQUALITY TEST:", (<string>"maryam rasheed")==="maryam rasheed" );
console.log("INEQUALITY TEST:", (<string>"maryam rasheed") ==="fatima" );
console.log("Lowercase Test:","maryam rasheed".toLowerCase()==="maryam rasheed")
console.log("EQALITY TEST:",1000===1000)
console.log("INEQALITY TEST:",(<number>10) !== 9)
...
console.log("\n\t\"FAVOURITE FRUITS\"")
let favourite_fruits:string[]=["apple","grapes","pineapple"]
...
console.log("\n\t\"HELLO ADMIN\"")
let users:string[]=['babar',"shadab","rizwan","fakhar","admin"];
...
console.log("\n\t\"NO USERS\"")
let usernames:string[]=["ali","hammad","humza","muhammad"]
...
console.log("\n\t\"CHECKING USERNAMES\"")
let current_users:string[]=["lisa","jennie","rose","jisoo","pharita"];
let new_users:string[]=["diana","natalia","jennie","olivia","lisa"];
...
console.log("\n\t\"PIZZAS\"")
let pizzas:string[]=["Veggie Pizza","Cheese Pizza","BBQ Chicken Pizza "]
...
console.log("\n\t\"ANIMALS\"")
let animals:string[]=["Cat","Rabbit","Hamster"]
...
console.log("\n\t\"T-Shirt's\"")
let shirts:string[]=["small","medium-size","large"]
...
let size:string[]=["Extralarge , medium"]
...
let city:string[]=["KARACHI","BEJING","SEOUL"]
...
console.log("\n\t\"CITIE's NAME's\"")
let cityname:string[]=["Islamabad,PAKISTAN","Busan,KOREA","Jadah,SAUDIA ARABIA"]
...
console.log("\n\t\"MAGICIANS\"")
let magicians_name:string[]=["David Blaine","Derren Brown","Harry Houdini","Criss Angel"]
...
let greatmagicians_name:string[]=["David Blaine","Derren Brown","Harry Houdini","Criss Angel"]
function show_magicians(greatmagicians_name:string[]){
...
let magicians:string[]=["David Blaine","Criss Angel","Harry Houdini"]
